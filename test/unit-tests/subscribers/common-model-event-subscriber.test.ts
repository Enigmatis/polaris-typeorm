...
describe('common model event subscriber tests', () => {
    ...
    it('beforeInsert - all the common model fields defined as needed', async () => {
    ...
    it('beforeInsert - without upn and with requesting system id', async () => {
    ...
    it('beforeInsert - without reality id, so reality id is the default(which is 0)', async () => {
    ...
    it('beforeInsert - check that the logger called as needed', async () => {
        const connection = setConnection(1);
        const event = new DummyInsertEvent(connection, bookEntity);
        await commonModelEventSubscriber.beforeInsert(event);
        expect(connection.logger.log).toBeCalledTimes(2);
    });
    it('beforeUpdate - all the common model fields defined as needed', async () => {
    ...
    it('beforeUpdate - without upn and with requesting system id', async () => {
    ...
    it('beforeUpdate - without reality id, so reality id is the default(which is 0)', async () => {
    ...
    it('beforeUpdate - check that the logger called as needed', async () => {
        const connection = setConnection(1);
        const event = new DummyUpdateEvent(connection, bookEntity);
        await commonModelEventSubscriber.beforeUpdate(event);
        expect(connection.logger.log).toBeCalledTimes(2);
